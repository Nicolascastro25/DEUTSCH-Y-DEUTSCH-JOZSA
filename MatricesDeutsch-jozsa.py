...
print("Funcion 2")
a2 = [[0 for k in range(2**(5))] for l in range(2**(5))]
aux = 0
for i in range(2):
    for j in range(2):
        for k in range(2):
            for l in range(2):
                for m in range(2):
                    ...
                    recorrido = r.get_counts(c)
                    for z in recorrido:
                        a2[traducirbits(z)][aux] = 1
                    aux += 1
imprimir(a2)

print("Funcion 3")
a3 = [[0 for k in range(2**(5))] for l in range(2**(5))]
aux = 0
for i in range(2):
    for j in range(2):
        for k in range(2):
            for l in range(2):
                for m in range(2):
                    ...
                    recorrido = r.get_counts(c)
                    for z in recorrido:
                        a3[traducirbits(z)][aux] = 1
                    aux += 1
imprimir(a3)

print("Funcion 4")
a4 = [[0 for k in range(2**(5))] for l in range(2**(5))]
aux = 0
for i in range(2):
    for j in range(2):
        for k in range(2):
